...
class EnPreprocessor(object):
    ...
    def clean_sent(self, row_sent, lower=False):
        """ 
        处理英文字符串，用空格替换非英文
...
if __name__ == "__main__":
    ...
    test_cent = u"I've got it. 'Yes, ma'am.' the waiter said.'好Yes, it is doctors'.' 'Yes, it is doctors'' he said."
    # test_cent = u"haha, \"www.qq@123.google.com\" tt2th 3st !"

    print test_cent
    print en_preprocessor.clean_sent(test_cent)
    print en_preprocessor.clean_sent(test_cent, lower=True)
