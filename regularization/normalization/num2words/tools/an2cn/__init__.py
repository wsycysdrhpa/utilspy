...
L_NUMERAL = [u"零", u"一", u"二", u"三", u"四", u"五", u"六", u"七", u"八", u"九"]
L_NUMERAL_CAPITAL = [
    u"零", u"壹", u"贰", u"叁", u"肆", u"伍", u"陆", u"柒", u"捌", u"玖"
]

L_UNIT = [
    u"", u"十", u"百", u"千", u"万", u"十", u"百", u"千", u"亿", u"十", u"百", u"千",
    u"万", u"十", u"百", u"千"
]
L_UNIT_CAPITAL = [
    u"", u"拾", u"佰", u"仟", u"万", u"拾", u"佰", u"仟", u"亿", u"拾", u"佰", u"仟",
    u"万", u"拾", u"佰", u"仟"
]
    ...
    for i, d in enumerate(data):
        if int(d):
            ...
            if not (len_input_cn - i - 1) % 4:
                output_an += numeral_list[int(d)] + unit_list[len_input_cn - i
                                                              - 1]
...
def an2cn(input_an=u"000", b_is_cap=False):
    ...
    if len_split_input_an == 1:
        ...
        raise Exception(u"错误，请检查数据格式。" + " " + str(input_an))
