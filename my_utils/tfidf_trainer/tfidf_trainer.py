...
if __name__ == "__main__":
    ...
    dictionary_test = tfidf_trainer.file_2_dictionary('file/test/in_test.txt')
    tfidf_model_test = tfidf_trainer.file_2_tfidf_model('file/test/in_test.txt')

    # tfidf_dict_test = tfidf_trainer.file_conn_2_dict(tfidf_model_test, dictionary_test, 'file/test/in_test.txt')
    ...
    # tfidf_dict_list = tfidf_trainer.file_2_dict_list(tfidf_model_test, dictionary_test, 'file/test/in_test.txt')
